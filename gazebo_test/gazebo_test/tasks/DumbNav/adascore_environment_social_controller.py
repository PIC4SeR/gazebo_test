...
from gazebo_test.utils.nav_utils import *
from gazebo_test.utils.sfm import SocialForceModel
...
class Pic4rlEnvironmentAdascore(Node):
    def __init__(self):
        ...
        print(
            "Changing navigation scenario every ",
            training_params["--change_goal_and_pose"],
            " episodes.",
        )
    ...
    def new_episode(self):
        ...
        if self.episode % 3 == 0.0 or self.mode == "testing":
    ...
    def send_goal(self, pose, reset=False):
        ...
        if self.save_paths_file and reset:
            ...
            while path_to_goal is None:
                path_to_goal = self.navigator.getPath(
                    start=PoseStamped(), goal=goal_pose
                )
